...
<div class="min-w-screen min-h-screen bg-gray-100 px-5 py-5">
    ...
    <div class="w-full bg-white px-5 py-10 text-gray-600 mb-10">
        
        <div class="text-center max-w-xl mt-10 mx-auto">
            <h1 class="text-5xl md:text-6xl font-bold mb-5">Pricing</h1>
        </div>
        
        <div class="max-w-4xl gap-x-4 mx-auto flex flex-col justify-center md:flex-row">
            <!-- protege sup -->
            <div class="w-full md:w-1/3 md:max-w-none bg-white px-8 md:px-10 py-8 md:py-10 mb-3 md:my-6 rounded-md shadow-lg shadow-gray-600 md:flex md:flex-col">
